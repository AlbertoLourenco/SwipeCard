...
struct MockedData {
    ...
    static private func randomGallery(imageName: String) -> Array<String> {
    ...
    static func animals() -> Array<Animal> {
        ...
        let dog = Animal(order: 0,
                         ...
                         gallery: MockedData.randomGallery(imageName: "Dog"),
        ...
        let cat = Animal(order: 1,
                         ...
                         gallery: MockedData.randomGallery(imageName: "Cat"),
        ...
        let bird = Animal(order: 2,
                          ...
                          gallery: MockedData.randomGallery(imageName: "Bird"),
        ...
        let octopus = Animal(order: 3,
                             name: "Octopus",
                             description: "There are many variations of passages of Lorem Ipsum available.",
                             gallery: MockedData.randomGallery(imageName: "Octopus"),
        ...
        let owl = Animal(order: 4,
                         ...
                         gallery: MockedData.randomGallery(imageName: "Owl"),
        ...
        let frog = Animal(order: 5,
                          name: "Frog",
                          description: "If you're going to use 'Lorem Ipsum', you need to be sure there isn't anything embarrassing.",
                          gallery: MockedData.randomGallery(imageName: "Frog"),
